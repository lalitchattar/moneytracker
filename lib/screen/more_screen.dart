  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text(Constants.moreScreenAppBarTitle),
          centerTitle: true,
        ),
            ...
            children: [
              ...
              Padding(
                ...
                child: Card(
                  ...
                  color: Utils.getColorFromColorCode(Constants.screenBackgroundColor),
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 15.0),
                    child: Wrap(
                      runSpacing: -5,
                      children: [
                        Row(
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                  letterSpacing: 1.0,
                                  color: Utils.getColorFromColorCode(Constants.moreScreenSectionTitleColor),
                                  fontSize: 14.0,
                        ...
                        ListTile(
                          ...
                          title: const Text(
                            Constants.moreScreenAccountMenuText,
                          ),
                        ...
                        ListTile(
                          ...
                          leading: const CircleAvatar(
                            radius: 20.0,
                            child: SvgIcon(
                              AllScreenIcon.category,
                              color: Colors.white,
                            ),
                          ),
                          title: const Text(
                            Constants.moreScreenCategoryMenuText,
                          ),
                          trailing: const Icon(Icons.arrow_forward_ios),
                          onTap: () {
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          leading: const CircleAvatar(
                            radius: 20.0,
                            child: SvgIcon(
                              AllScreenIcon.reminder,
                              color: Colors.white,
                            ),
                          ),
                          title: const Text(
                            Constants.moreScreenReminderText,
                          ),
                          trailing: Switch(
                            value: _applicationConfig.getReminderSetting(),
                            onChanged: (value) {
                              setState(() {
                        ...
                        ListTile(
                          ...
                          leading: const CircleAvatar(
                            radius: 20.0,
                            child: SvgIcon(
                              AllScreenIcon.reminderTime,
                              color: Colors.white,
                            ),
                          ),
                          title: const Text(
                            Constants.moreScreenReminderTimeText,
                          ),
                          trailing: const Text(
                            Constants.reminderTime,
                          ),
                          onTap: () {},
                        ),
                        const Divider(
                        ...
                        ListTile(
                          ...
                          leading: const CircleAvatar(
                            radius: 20.0,
                            child: SvgIcon(
                              AllScreenIcon.currency,
                              color: Colors.white,
                            ),
                          ),
                          title: const Text(
                            Constants.moreScreenCurrencyMenuText,
                          ),
                          trailing: Text(
                            _applicationConfig.configMap!["CURRENCY"].toString(),
                          ),
                          onTap: () {
                            showCurrencyPicker(
                              context: context,
                        ...
                        ListTile(
                          ...
                          leading: const CircleAvatar(
                            radius: 20.0,
                            child: SvgIcon(
                              AllScreenIcon.backup,
                              color: Colors.white,
                            ),
                          ),
                          title: const Text(
                            Constants.moreScreenBackupText,
                          ),
                          onTap: () {},
                        ),
                        const Divider(
                        ...
                        ListTile(
                          ...
                          title: const Text(
                            Constants.moreScreenResetDataMenuText,
                          ),
                          onTap: () {},
                        ),
                      ],
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          leading: const CircleAvatar(
                            radius: 20.0,
                            child: SvgIcon(
                              AllScreenIcon.feedback,
                              color: Colors.white,
                            ),
                          ),
                          title: const Text(
                            Constants.moreScreenFeedbackText,
                          ),
                          onTap: () {},
                        ),
                        const Divider(
                        ...
                        ListTile(
                          ...
                          leading: const CircleAvatar(
                            radius: 20.0,
                            child: SvgIcon(
                              AllScreenIcon.rating,
                              color: Colors.white,
                            ),
                          ),
                          title: const Text(
                            Constants.moreScreenRateText,
                          ),
                          onTap: () {},
                        ),
                        const Divider(
